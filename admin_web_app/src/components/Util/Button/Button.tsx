...
function Button(props: ButtonProps) {
  ...
  return (
    <>
      <button {...rest} className={`flex relative items-center justify-center bg-dark text-white font-medium w-full p-1 rounded-md ${props.className}`}>
        {text}
        {isLoading ? (
          <div className="absolute right-2" role="status">
